      ...
      <div style={{ maxWidth: "820px", margin: "0 auto" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "1.8rem", fontFamily: "'Inter', sans-serif", fontSize: "clamp(0.95rem,2vw,1.05rem)", lineHeight: 1.8, color: T }}>
          ...
          <p ref={p2Ref} className="sr-hidden sr-delay-2">
            ...
            {" "}as a UI/UX graduate. That journey sharpened my eye: when something is visually off, when a flow feels awkward, when a layout doesn't serve the user. Those same instincts carry directly into QA.
          </p>
