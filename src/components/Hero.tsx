    ...
    <>
      ...
      <section id="hero">
        ...
        <div id="hero-content">
          ...
          <p id="hero-sub">
            Johnatan Milrad, Manual QA graduate with UI/UX sensibility combining a designer's
            instinct with systematic testing to catch what others miss.
          </p>

          <div id="hero-tags">
            {["// Manual QA Graduate", "// Manual Testing", "// Bug Reporting", "// Test Planning", "// UI/UX Sensibility"].map(t => (
